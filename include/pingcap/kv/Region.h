...
{
public:
    RegionCache(pd::ClientPtr pdClient_, const std::string & key_, const std::string & value_)
        : pd_client(pdClient_), learner_key(key_), learner_value(value_), log(&Logger::get("pingcap.tikv"))
    {}
